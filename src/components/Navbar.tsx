  ...
  return (
    <>
      <div className="fixed w-[100vw] h-[8vh] overflow-hidden font-press-start z-30 p-10 pt-16 lg:justify-around justify-between items-center flex">
        ...
        />
        <button className="ring-2 ring-[#F8B95A] rounded-md shadow-red-glow flex flex-wrap text-white lg:text-xl text-xs px-2 gap-x-4 lg:h-14 lg:w-40 h-[4vh] border border-solid border-[#F8B95A] bg-[#F8B95A] bg-opacity-50 items-center justify-center relative left-[7vw] lg:left-[0vw]">
          Join
          <img src="discord.svg" className="h-[2vh] lg:h-[3vh] xl:h-[4vh]" />
        </button>
      </div>
    </>
  );

        ...
        <div className="w-full flex justify-center items-start overflow-y-auto h-full max-h-[50vh] md:max-h-[65vh] touch-pan-y">
          ...
          <div className="w-full px-4 md:px-2 prose markdown-content prose-invert max-w-none break-words">
            ...
            <div className="bg-[#232334] bg-opacity-50 p-4 rounded-lg border-l-4 border-[#F8B95A] mb-6">
              ...
              <ul className="pl-2 mb-2 text-white list-none text-sm md:text-base">
                <li className="mb-2">
                  🌀 <strong>Framer Motion</strong> (Great for React-based animations)
                </li>
                <li className="mb-2">
                  🚀 <strong>GSAP</strong> (Industry standard for complex timelines)
                </li>
                <li className="mb-2">
                  🎭 <strong>React Spring</strong> (Physics-based animations)
                </li>
                <li className="mb-2">
                  💅 <strong>Tailwind Animate</strong> (Simple utility-based animations)
                </li>
              </ul>
            ...
            <ul className="pl-2 mb-4 text-white list-none text-sm md:text-base">
              <li className="mb-2">
                ...
                <strong>any frontend framework</strong> (React, Next.js, Vue, or plain HTML/CSS).
              </li>
              <li className="mb-2">
                ✅ <strong>Asset Handling:</strong> You can inspect the website to grab SVG icons or use similar placeholders.
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                ...
                mandatory. Tell us what you built, what tools you used, and how to run it.
              </li>
            </ul>
            ...
            <p className="text-center text-[#F8B95A] font-bold mt-8 text-sm md:text-base">

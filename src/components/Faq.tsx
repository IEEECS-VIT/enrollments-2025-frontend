        ...
        <div className="relative min-h-screen flex items-center justify-center">
            ...
            <div className="absolute w-full z-20 pointer-events-auto">
                <div className="text-white min-h-screen flex flex-col items-center justify-center font-press-start">
                    <div className="border-2 border-white mt-[10vh] rounded-3xl w-[70%] lg:w-[60%] sm:h-[65vh] h-[75vh] flex flex-col items-center p-4 md:p-8 overflow-y-auto overflow-x-hidden">

...
export default function Management() {
  ...
  return (
    <div className="text-white min-h-screen flex flex-col items-center justify-center font-playmegames">
      <div className="border-2 border-[#FF0004] sm:mt-0 mt-[10vh] rounded-3xl w-[80%] sm:w-[80%] md:w-[80%] lg:w-[70%] sm:h-[60vh] h-[70vh] flex flex-col items-center">
        ...
        <div
          className="flex flex-col sm:flex-row gap-8 sm:gap-20 md:gap-32 lg:gap-80 justify-center items-center w-full mt-24"
        ...
        >
          {['Events', 'PnM'].map((label, index) => (
            <div
              key={index}
              className="flex flex-col items-center cursor-pointer nav-button p-4 transition-transform duration-300"

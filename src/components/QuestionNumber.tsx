...
const QuestionNumber: React.FC<QuestionNumberProps> = ({
  ...
  return (
    <div className="flex w-full justify-center mt-8 px-4">
      {/* Left arrow */}
      <button
        className="flex items-center bg-black justify-center w-8 h-8 sm:w-10 sm:h-10 border border-white rounded-lg mx-2 sm:mx-4 text-white cursor-pointer hover:bg-[#f8770f] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        onClick={() =>
          onQuestionChange(

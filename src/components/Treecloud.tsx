export default function Treecloud() {
    return (
      <div className="relative min-h-screen min-w-screen overflow-hidden">
        ...
        <img className="absolute bottom-0 left-0 h-[16vh] sm:h-[25vh] lg:h-[34vh]" src="/Tree.svg" alt="Tree Image" />
        <img className="absolute bottom-0 right-0 h-[16vh] sm:h-[25vh] lg:h-[35vh]" src="/Tree.svg" alt="Tree Image" />
      </div>
    );
  }
